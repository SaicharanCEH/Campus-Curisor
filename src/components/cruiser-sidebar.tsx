                        ...
                        <ul className="space-y-2">
                            ...
                            <li key={stop.id}>
                                ...
                                <div className="flex justify-between items-center w-full">
                                    <span>{stop.name}</span>
                                    <Button size="icon" variant="ghost" onClick={(e) => { e.stopPropagation(); onToggleFavorite(stop.id);}}>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex justify-between items-center">
                ...
                <Button size="icon" variant="ghost" onClick={() => onToggleFavorite(selectedStop.id)}>
